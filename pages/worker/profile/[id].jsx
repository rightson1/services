        ...
        return <div className="flex">
            ...
            <div className="w-full flex-2 flex-col">
                ...
                <div className="flex flex-col px-4 gap-4 items-center ">
                    ...
                    {user.avatar && <div className=" w-full height-[300px] flex items-center justify-center">
                    ...
                    <div className="flex items-center shadow-lg p-4">
                        <p className="font-bold text-3xl">Field:</p><h1 className="font-semibold text-3xl">{user.type}</h1>
